function extractMetadataFromUrl(url: string) {
  ...
  // PRESERVE model numbers, clean punctuation only
...
console.log("Flipkart slug test:", extractMetadataFromUrl("https://www.flipkart.com/noise-colorfit-pro-5-max-1-96-amoled-display-bt-calling-metallic-build-smartwatch/p/itm6e2e2c6b1a3eb"));
console.log("Amazon slug test:", extractMetadataFromUrl("https://www.amazon.in/boAt-Airdopes-141-Playtime-Resistance/dp/B09N3ZNHTY"));
