...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onView }) => {
  ...
  return (
    <div className="group rounded-3xl bg-white border border-[var(--border-card)] hover:border-[var(--green-primary)]/40 transition-all duration-300 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 flex flex-col">
      {/* Image */}
